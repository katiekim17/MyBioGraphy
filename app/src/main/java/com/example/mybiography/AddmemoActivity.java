...
public class AddmemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //불러오기
//        Memo memo1 = (Memo) getIntent().getSerializableExtra("memoClass");

//        String memoTitle = intent.getExtras().getString("memoTitle");
//        Log.d("AddmemoActivity54", memo1.editMemoStr);
//        if (memoTitle != null) {
//            editMemoTitle.setText(memoTitle);
//        }
        Log.d("AddmemoActivity60", editMemoTitle.getText().toString());
